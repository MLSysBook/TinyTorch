...
% Feature layers - stacked above timeline with proper alignment
...
% Layer 2: Gradient features - properly aligned at Module 05 transition
% .requires_grad
\node[dormant] at (2.25, 2.7) {\texttt{.requires\_grad}};
\draw[gray!60, thick, dashed] (0.3, 2.7) -- (6, 2.7);
\node[active] at (7.5, 2.7) {\texttt{.requires\_grad}};
\draw[orange!80, thick] (6, 2.7) -- (13.7, 2.7);
\node[left, font=\tiny] at (0.2, 2.7) {Gradient};

% .grad
\node[dormant] at (2.75, 3.6) {\texttt{.grad}};
\draw[gray!60, thick, dashed] (0.3, 3.6) -- (6, 3.6);
\node[active] at (7.5, 3.6) {\texttt{.grad}};
\draw[orange!80, thick] (6, 3.6) -- (13.7, 3.6);

% .backward()
\node[dormant] at (2.0, 4.5) {\texttt{.backward()}};
\draw[gray!60, thick, dashed] (0.3, 4.5) -- (6, 4.5);
\node[active] at (7.5, 4.5) {\texttt{.backward()}};
\draw[orange!80, thick] (6, 4.5) -- (13.7, 4.5);

% Activation marker at Module 05 - centered above transition point
\node[draw, fill=yellow!30, circle, font=\tiny\bfseries, minimum size=0.8cm] at (6, 5.5) {ACTIVATE};
\draw[thick, ->] (6, 5.1) -- (6, 4.7);

% Annotations - positioned above activation marker
