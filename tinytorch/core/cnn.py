# AUTOGENERATED! DO NOT EDIT! File to edit: ../../assignments/source/05_cnn/cnn_dev.ipynb.

# %% auto 0
__all__ = ['conv2d_naive', 'Conv2D', 'flatten']

# %% ../../assignments/source/05_cnn/cnn_dev.ipynb 3
import numpy as np
...
# %% ../../assignments/source/05_cnn/cnn_dev.ipynb 5
...
# %% ../../assignments/source/05_cnn/cnn_dev.ipynb 6
def conv2d_naive(input: np.ndarray, kernel: np.ndarray) -> np.ndarray:
    H, W = input.shape
    kH, kW = kernel.shape
...
# %% ../../assignments/source/05_cnn/cnn_dev.ipynb 12
class Conv2D:
    """
...
# %% ../../assignments/source/05_cnn/cnn_dev.ipynb 13
class Conv2D:
    def __init__(self, kernel_size: Tuple[int, int]):
...
# %% ../../assignments/source/05_cnn/cnn_dev.ipynb 17
...
# %% ../../assignments/source/05_cnn/cnn_dev.ipynb 18
def flatten(x: Tensor) -> Tensor:
    """Flatten a 2D tensor to 1D (for connecting to Dense)."""
